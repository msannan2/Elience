...
public class JsonUtils {
    ...
    public static ContentValues[] getUserContentValuesFromJson(String jsonString) throws JSONException {
        ...
        for (int i = 0; i < jFriends.length(); i++) {
            ...
            userValues.put(DatabaseContract.Friends.COLUMN_UID, id);
        ...
        for (int i = 0; i < jPending.length(); i++) {
            ...
            userValues.put(DatabaseContract.Friends.COLUMN_UID, id);
            userValues.put(DatabaseContract.Friends.COLUMN_NAME, name);
            userValues.put(DatabaseContract.Friends.COLUMN_TYPE, "pending");
    ...
    public static ContentValues[] getConversationContentValuesFromJson(String jsonString) throws JSONException {
        ...
        for (int i = 0; i < jArray.length(); i++) {
            ...
            conversationValues.put(DatabaseContract.Conversations.COLUMN_UID, id);
            conversationValues.put(DatabaseContract.Conversations.COLUMN_USER_ID, user);
    ...
    public static ContentValues[] getMessagesContentValuesFromJson(String jsonString) throws JSONException {
        ...
        for (int i = 0; i < jArray.length(); i++) {
            ...
            ContentValues conversationValues = new ContentValues();
            conversationValues.put(DatabaseContract.Messages.COLUMN_MESSAGE_ID, message_id);
            conversationValues.put(DatabaseContract.Messages.COLUMN_CONVERSATION_ID, conversationUID);
            conversationValues.put(DatabaseContract.Messages.COLUMN_SENDER_ID, user);
            conversationValues.put(DatabaseContract.Messages.COLUMN_MESSAGE, message);
            conversationValues.put(DatabaseContract.Messages.COLUMN_CREATED_AT, created_at);

...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groupsRef = FirebaseDatabase.getInstance().getReference().child("Therapists").child(currentGroupName).child("Questions").child(currentUserID).child("chats");
        //setTransparency();
        Initialize();
        GetUserInfo();
    ...
    private void SaveMessagetoDB() {
        ...
        if (!TextUtils.isEmpty(message) && ProfanityChecker.CheckforProfanity(message)) {
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Therapists").child(currentGroupName).child("Questions").child(currentUserID).child("chats");

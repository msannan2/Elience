...
public class GroupChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groupsRef = FirebaseDatabase.getInstance().getReference().child("Groups").child(currentGroupName);
        //setTransparency();
        Initialize();
        GetUserInfo();
    ...
    private void SaveMessagetoDB() {
        ...
        if (!TextUtils.isEmpty(message) && ProfanityChecker.CheckforProfanity(message)) {
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Groups").child(currentGroupName);
    ...
    private void Initialize() {
        ...
        headerText.setText(currentGroupName);
   ...
   /* @Override
    ...
    private void UpdateLastSeen() {
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserID).child("Usergroups").child(currentGroupName).updateChildren(data);
    }

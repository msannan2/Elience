...
public class DatabaseDbHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(SQL_DROP_TABLE_IF_EXISTS + DatabaseContract.Friends.TABLE_NAME);
        db.execSQL(SQL_DROP_TABLE_IF_EXISTS + DatabaseContract.Conversations.TABLE_NAME);
        db.execSQL(SQL_DROP_TABLE_IF_EXISTS + DatabaseContract.Messages.TABLE_NAME);
        onCreate(db);
    }
